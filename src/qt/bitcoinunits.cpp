...
QString BitcoinUnits::name(int unit)
{
    switch(unit)
    {
    case BTC: return QString("BIXC");
    case mBTC: return QString("mBIXC");
    case uBTC: return QString::fromUtf8("μBIXC");
...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString(QObject::tr("BixCs"));
    case mBTC: return QString(QObject::tr("Milli-BixCs (1 / 1,000)"));
    case uBTC: return QString(QObject::tr("Micro-BixCs (1 / 1,000,000)"));
    default: return QString("???");
    }
}
